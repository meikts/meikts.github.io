...
function __checkInit() {
    "undefined" == typeof jQuery ? setTimeout(__checkInit, 10) : $(function() {
        if ($("meta:last").after('<meta name="theme-color" content="#000000">'), aidn.util.initStandAlone(), _isJapanese || null != document.getElementById("google_translate_element") && $.getScript("//translate.google.com/translate_a/element.js?cb=__googleTranslateElementInit",
            ...
            if (aidn.util.checkJapanese() && (e = aidn.constant.advUrlJa), e = '<a href="' + e + '" target="_blank"><div class="adv_con"><p class="text">' + aidn.constant.advTex + "</p>", e += '<p class="image"><img src="' + aidn.constant.advImg + '" alt="' + aidn.constant.advAlt + '" /></p>', e += "</div></a>", 0 < $(".adv").length) $(".adv").html(e),
...
aidn.init = {
        ...
        loadScript: function(e, t) {
            ...
            var n = function(i) {
                ...
                aidn.init.usebase && 0 != o.indexOf("http") && (o = aidn.init.basepath + o),
                    $.getScript(o,
                        function() {
    ...
    aidn.config = {
        init: function() {
            this.clWidth = document.documentElement.clientWidth,
                ...
                (0 >= this.clHeight || 0 >= this.clWidth) && (this.clWidth = this.scWidth, this.clHeight = this.scHeight),
                (0 >= this.inHeight || 0 >= this.inWidth) && (this.inWidth = this.clWidth, this.inHeight = this.clHeight)
        },
        clWidth: 0,
        clHeight: 0,
        scWidth: 0,
    ...
    aidn.event = {
        addTouchEvent: function(e, t, n, i, o) {
            "string" == typeof e && (e = document.getElementById(e)),
                ...
                o && e.addEventListener("touchcancel", o, !1)
        },
        removeTouchEvent: function(e, t, n, i, o) {
            "string" == typeof e && (e = document.getElementById(e)),
                ...
                o && e.removeEventListener("touchcancel", o, !1)
        },
        addMouseEvent: function(e, t, n, i, o) {
            "string" == typeof e && (e = document.getElementById(e)),
                ...
                o && e.addEventListener("mouseout", o, !1)
        },
        removeMouseEvent: function(e, t, n, i, o) {
            "string" == typeof e && (e = document.getElementById(e)),
                ...
                o && e.removeEventListener("mouseout", o, !1)
        },
    ...
    aidn.util = {
        ...
        getCookie: function(e) {
            ...
            return 0 <= i && (t = i + n.length, -1 == (n = e.indexOf(";", t)) && (n = e.length), t = decodeURIComponent(e.substring(t, n))),
                t
        },
        ...
        needExpandArea: function(e) {
            var t = navigator.userAgent,
                n = 0 <= t.indexOf("iPhone") || 0 <= t.indexOf("iPod");
            return (n = n && 0 <= t.indexOf("Version/") && 600 > Math.max(window.screen.width, window.screen.height)) && 1 == e && ($("html,body").css("position", "static"), $(window).on("touchmove.noScroll",
                    function(e) {
                        e.preventDefault()
    ...
    aidn.window = {
        ...
        resize: function(e, t) {
            aidn.window._isFit = t,
                void 0 === t && (aidn.window._isFit = !0),
    ...
    aidn.social = {
        ...
        reloadTw: function(e, t, n, i) {
            ...
            e && (o += ' data-text="' + e + '"'),
                ...
                n && (o += 'data-count="' + n + '"'),
                i && (o += 'data-url="' + i + '"'),
                o += ' data-lang="en">Tweet</a>',
                $("#twitter").append(o),
                this.initTw()
        },
        shareTw: function(e, t, n, i, o) {
            0 <= e.indexOf("https://aidn.jp") && (e = e.replace("https", "http")),
                e = "https://twitter.com/intent/tweet?url=" + encodeURIComponent(e),
                n && (e += "&text=" + encodeURIComponent(n)),
                i && (e += "&related=" + i),
                o && (e += "&hashtags=" + encodeURIComponent(o)),
                t && !aidn.util.checkMobile() ? window.open(e, "tw", "width=730, height=460, personalbar=0,toolbar=0,scrollbars=1,resizable=1") : location.href = e
        },
...
__checkInit(),
    ...
    aidn.Audio = function() {
        ...
        this._audio = d,
            ...
            d.addEventListener("timeupdate",
                function() {
                    t <= d.currentTime && d.pause(),
                        0 < d.currentTime && o && (o(), o = null)
                }),
            d.addEventListener("ended",
                function() {
                    a && a(),
                        n && (d.currentTime = 0, d.play(), d.playbackRate = s)
                }),
            ...
            this.play = function(i, a, s, c, u) {
                ...
                d.play(),
                    0 < c && "undefined" != typeof jQuery ? (r.volume = 0, $(r).stop().animate({
                            volume: u
                        },
    ...
    aidn.WebAudio = function() {
        ...
        this.load = function(e, i, o) {
                function a() {
                    t.decodeAudioData(f ? r.buffer : b.response,
                        function(e) {
                            if (0 <= w) {
                                for (var o = w,
                                        a = Number.MAX_VALUE,
            ...
            this.play = function(f, g, w, b, x, E) {
                if (d = f, s = g, c = w, u = b, l = x, h = E, n) {
                    void 0 === f && (f = 0),
                        ...
                        void 0 === x ? x = y : y = x,
                        void 0 === E && (E = 0),
                        (i = t.createBufferSource()).buffer = n,
                        i.loop = g,
                        i.onended = e,
                        a || (a = t.createGain()),
                        g = (g = [i, a]).concat(p),
                    ...
                    for (var O = 1; O < g.length; O++) {
                        var k = g[O];
                        g[O - 1].connect(k),
                            O == g.length - 1 && k.connect(t.destination)
                    }
            ...
            this.stop = function() {
                _ = !1,
                    i && (i.stop ? i.stop(0) : i.noteOff())
            },
            this.initPanner = function(e) {
                return (void 0 === e || 0 >= e) && (e = "equalpower"),
                    0 < e && (e = "HRTF"),
                    o = t.createPanner(),
                    o.panningModel = e,
                    this.nodePanner = o
    ...
    aidn.AutoAudio = function(e, t, n) {
        void 0 === e && (e = "../shared/swf/audio.swf"),
            aidn.audio.init();
        var i = 2;
        "undefined" != typeof swfobject && swfobject.hasFlashPlayerVersion(10) && null != e ? i = 0 : aidn.util.webaudio && (i = 1),
            0 <= n && 2 >= n && (i = n);
        var o, a, r;
        if (___flash_audioLoadComplete = function() {
            ...
            0 == i) {
            (n = document.createElement("div")).id = "flash_audio",
            ...
            var d = setInterval(function() {
                ...
                100)
        } else this.audio = o = 1 == i ? new aidn.WebAudio : new aidn.Audio,
        ...
        this.load = function() {
            ...
            this.play = function() {
                0 == i && arguments[2] && (r = arguments[2], arguments[2] = "___flash_audioPlay"),
                    (o.playFunc || o.play).apply(o, arguments)
            },
            this.stop = function() {
