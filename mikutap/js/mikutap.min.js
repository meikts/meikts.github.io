...
var MainManager = function() {
    ...
    function i(a) { (X = !X) ? ($("#bt_backtrack a").text("BGM : OPEN"), aidn.util.setCookie("bt", "on", 2592e3)) : ($("#bt_backtrack a").text("BGM : CLOSE"), aidn.util.setCookie("bt", "off", 2592e3)),
        a && a.preventDefault()
    }
    function o() {
    ...
    $("#bt_back").click(function() {
        ...
        case 1:
            ...
            break;
        default:
            location.href = "https://moi-mo.github.io"
        }
    }),
    ...
    i(),
    aidn.util.webaudio ? ($("#ng").css("display", "none"), $(".ok").css("display", "block"), m && $("#scene_main .attention").html("TOUCH! SLIDE!"), u || $("#scene_top .attention").text("* TURN YOUR SOUND ON AND ENJOY! ")) : ($("#ng").css("display", "block"), $(".ok").css("display", "none"), u || $("#ng .atten").html("抱歉，</br>你的浏览器不支此页面")),
